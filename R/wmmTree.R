...
#' Zhats <- wmmTree(tree2, sample_length = 15)
...
#'
#' ## show the average root estimate wiht 95\% confidence interval, as well as
#' ## average estimates with confidence intervals for each node with a marginal count
